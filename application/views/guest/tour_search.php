...
<h2>ツアー検索</h2>
<form action="<?php echo base_url("tour/search");?>" method="get">
<fieldset>
<legend>ツアー検索</legend>
<div>
...
<div>
	...
	<select name="limit" id="pg_search_limit">
		<option value="3"<?php if($this->input->get("limit") == 3):?> selected="selected"<?php endif;?>>3</option>
